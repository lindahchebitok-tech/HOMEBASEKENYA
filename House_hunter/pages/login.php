        ...
        <div class="col-md-6">
            <div class="card glass-container">
                <div class="card-header glass-header">
                    <h4 class="text-center" style="color:black">Login <br> HOMEBASE KENYA</h4>
                </div>
                <div class="card-body glass-body">
                    <?php if(isset($_SESSION['success'])): ?>
                        <div class="alert glass-alert glass-alert-success"><?php echo $_SESSION['success']; unset($_SESSION['success']); ?></div>
                    <?php endif; ?>
                    ...
                    <form method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="password" class="form-control glass-form-control" required placeholder="Enter your password">
                        </div>
                        <button type="submit" class="btn glass-btn w-100">Login</button>
                    </form>
